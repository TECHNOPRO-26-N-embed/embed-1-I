...
|:---|:---|:---|:---|:---|
| 1 |距離測定| 2-2（関数：readDistance） | 3-1（ピン：D9 D10　） | テスト#1 |
| 2 |離席検知 | 2-2（関数：detectLeave） | センサー | テスト#2 |
| 3 |警告 | 2-2（関数：handleAlert） | LED,Buzzer | テスト#3 |
| 4 |停止| 2-2（関数：stopAlert） | Button | テスト#3 |
